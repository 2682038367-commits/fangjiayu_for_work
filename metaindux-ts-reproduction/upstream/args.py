...
arch_group.add_argument('--frequency_threshold', type=float, default=-1.0,
                        help='fixed spectral-mask quantile; negative keeps random initialization')
arch_group.add_argument(
    '--frequency_mask_mode',
    default='hard_random_quantile',
    choices=['hard_random_quantile', 'soft_learnable_energy', 'binary_ste_energy'],
)
arch_group.add_argument('--frequency_threshold_init', type=float, default=0.25)
arch_group.add_argument('--frequency_mask_temperature', type=float, default=0.1)
...
optim_group.add_argument('--eva_epoch', default=35, type=int, metavar='N')
...
optim_group.add_argument('--lr_schedule', default='warmup_cosine',
...
optim_group.add_argument('--task',default='all',type=str)
optim_group.add_argument('--loss_type',default='mse',choices=['mse', 'mse+mmd'],type=str)
optim_group.add_argument('--sample_type',default='ddim',choices=['ddim', 'ddpm'],type=str)
optim_group.add_argument('--seed', default=3, type=int)
optim_group.add_argument('--loss_history_path', default='', type=str)
optim_group.add_argument('--metrics_path', default='', type=str)
...
arg_parser.add_argument('--w',default=1.8,type=float)
